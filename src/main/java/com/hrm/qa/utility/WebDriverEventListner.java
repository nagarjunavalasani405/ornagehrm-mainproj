...
public class WebDriverEventListner extends BaseClass  implements WebDriverEventListener {
	 ...
	 */
	public void beforeScript1(String script, WebDriver driver) {
	}

	public void afterScript1(String script, WebDriver driver) {
	}
